...
df1<-read.csv('./data_HIV_network/exp_mech.csv')
df2<-read.csv('./data_HIV_network/randomized_version.csv')
df3 <- read.csv('./data_HIV_network/greedy_alg.csv')
greedy_vals=read.csv('./data_HIV_network/greedy_alg_reference.csv')
